...
namespace SoummySDK.Systems.Economy
{
    ...
    { 
        ...
        private void OnEnable() => ManagerMessages.EconomyMessages.OnEconomyUpdate.AddListener(UpdateEconomy);
        private void OnDisable() => ManagerMessages.EconomyMessages.OnEconomyUpdate.RemoveListner(UpdateEconomy);
